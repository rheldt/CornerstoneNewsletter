...
<html lang="en">
<head>
    <title><cfif isDefined("variables.pagetitle")><cfoutput>#variables.pagetitle#</cfoutput></cfif></title>
    <meta charset="utf-8" />
    ...
    <nav class="navbar navbar-inverse">
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/calendar/?token=#variables.token#">Cornerstone Calendar</a>
            </div>
            <div id="navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li <cfif not(structKeyExists(url, "format") and url.format is "mediashout")>class="active"</cfif>><a href="index.cfm?token=#variables.token#">For Bulletin</a></li>
                    <li <cfif structKeyExists(url, "format") and url.format is "mediashout">class="active"</cfif>><a href="index.cfm?token=#variables.token#&format=mediashout">For MediaShout</a></li>
                </ul>
            </div>
        </div>
        </cfoutput>
